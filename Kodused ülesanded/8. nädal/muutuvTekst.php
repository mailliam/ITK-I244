        ...
        <form method="POST" action="muutuvTekst.php">
            <table>
                <tr>
                    ...
                    <td><input type="text" name="tekstIse"></td>
                </tr>
                <tr>
                    <th>Vali teksti värv</th>
                    <td><input type="color" name="tekstiVarv"></td>
                </tr>
                <tr>
                    <th>Vali tausta värv</th>
                    <td><input type="color" name="taustaVarv" value="#ffffff"></td>
                </tr>
                <tr>
                    <th>Vali joone laius</th>
                    <td><input type="range" name="jooneLaius" min="0" max="20" step="1" value="2"></td>
                </tr>
                <tr>
